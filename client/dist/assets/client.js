...
;define("client/components/action-sheet/component", ["exports", "@glimmer/component", "@ember/service", "@ember/object", "@glimmer/tracking"], function (_exports, _component, _service, _object, _tracking) {
  "use strict";
  ...
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
  class ActionSheet extends _component.default {
    constructor(...args) {
      super(...args);
      _defineProperty(this, "rules", ["The objective in Coup is to be the last player remaining. Each player begins with two cards, referred to as " + "Influences. There are 5 types of Influences:", "LIST INFLUENCES HERE", "Each turn, a player takes one action. If the player is claiming an Influence, their opponents YADADA."]);
      ...
      _defineProperty(this, "card", {
        name: 'Contessa',
        revealed: false
      });
    }
  }
  _exports.default = ActionSheet;
});
;define("client/components/action-sheet/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
          ...
          <div class="card-action">
              <BsListGroup as |ListGroup|>
                  <ListGroup.item @type="secondary">
                      <Card @card={{action.name}} @self={{false}}/>
                  </ListGroup.item>
                  <ListGroup.item>
                      <strong>Action:</strong> {{action.action}}
                  </ListGroup.item>
                  <ListGroup.item>
                      <strong>Effect:</strong> {{action.effect}}
                  </ListGroup.item>
                  <ListGroup.item>
                      <strong>Counteraction:</strong> {{action.counteraction}}
                  </ListGroup.item>
              </BsListGroup>
          </div>
      {{/each}}
  ...
  */
  {
    "id": "XLJGzZk3",
    "block": "[[[10,0],[14,0,\"action-sheet-container\"],[12],[1,\"\\n\"],[42,[28,[37,1],[[28,[37,1],[[30,0,[\"actions\"]]],null]],null],null,[[[1,\"        \"],[10,0],[14,0,\"card-action\"],[12],[1,\"\\n            \"],[8,[39,2],null,null,[[\"default\"],[[[[1,\"\\n                \"],[8,[30,2,[\"item\"]],null,[[\"@type\"],[\"secondary\"]],[[\"default\"],[[[[1,\"\\n                    \"],[8,[39,3],null,[[\"@card\",\"@self\"],[[30,1,[\"name\"]],false]],null],[1,\"\\n                \"]],[]]]]],[1,\"\\n                \"],[8,[30,2,[\"item\"]],null,null,[[\"default\"],[[[[1,\"\\n                    \"],[10,\"strong\"],[12],[1,\"Action:\"],[13],[1,\" \"],[1,[30,1,[\"action\"]]],[1,\"\\n                \"]],[]]]]],[1,\"\\n                \"],[8,[30,2,[\"item\"]],null,null,[[\"default\"],[[[[1,\"\\n                    \"],[10,\"strong\"],[12],[1,\"Effect:\"],[13],[1,\" \"],[1,[30,1,[\"effect\"]]],[1,\"\\n                \"]],[]]]]],[1,\"\\n                \"],[8,[30,2,[\"item\"]],null,null,[[\"default\"],[[[[1,\"\\n                    \"],[10,\"strong\"],[12],[1,\"Counteraction:\"],[13],[1,\" \"],[1,[30,1,[\"counteraction\"]]],[1,\"\\n                \"]],[]]]]],[1,\"\\n            \"]],[2]]]]],[1,\"\\n        \"],[13],[1,\"\\n\"]],[1]],null],[13]],[\"action\",\"ListGroup\"],false,[\"each\",\"-track-array\",\"bs-list-group\",\"card\"]]",
    "moduleName": "client/components/action-sheet/template.hbs",
    "isStrictMode": false
  });
});
  ...
  /*
    <span class="card-wrapper {{this.cardClass}} {{if (and @card.revealed @self) 'revealed'}}">
      {{!-- <BsTooltip @placement="top">
          {{#if (eq this.cardClass "ambassador")}}
              <div class="card-desc">
                  <div>Action: Exchange</div>
                  <div>Counteraction: Block Steal</div>
              </div>
          {{else if (eq this.cardClass "assassin")}}
              <div class="card-desc">
                  <div>Action: Assassinate</div>
                  <div>Counteraction: Block Steal</div>
              </div>
          {{else if (eq this.cardClass "captain")}}
              <div class="card-desc">
                  <div>Action: Steal 2 <FaIcon @icon="coins" /></div>
                  <div>Counteraction: Block Steal</div>
              </div>
          {{else if (eq this.cardClass "contessa")}}
              <div class="card-desc">
                  <div>Action: None</div>
                  <div>Counteraction: Block Assassination</div>
              </div>
          {{else if (eq this.cardClass "duke")}}
              <div class="card-desc">
                  <div>Action: Exchange 2 <FaIcon @icon="card" /></div>
                  <div>Counteraction: Block Foreign Aid</div>
              </div>
          {{/if}}
      </BsTooltip> --}}
  ...
  /*
    <div class="chat">
      <BsCollapse @collapsed={{this.collapsed}}>
          <Log @messages={{@messages}} @isChat={{true}} @name={{@name}}/>
          <div class="send-chat">
...
;define("client/components/footer/component", ["exports", "@glimmer/component", "@ember/service", "@ember/object", "@glimmer/tracking", "client/config/environment"], function (_exports, _component, _service, _object, _tracking, _environment) {
  "use strict";
...
;define("client/components/footer/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
  ...
  /*
    <div class="footer-container">
      <a href="https://github.com/shanecjones1999/coup" target="_blank" rel="noopener noreferrer">Source Code</a> 
      | 
      <a href="mailto:shanecjones1999@gmail.com" target="_blank" rel="noopener noreferrer">Careers</a> 
  </div>
  */
  {
    "id": "0O67K70h",
    "block": "[[[10,0],[14,0,\"footer-container\"],[12],[1,\"\\n    \"],[10,3],[14,6,\"https://github.com/shanecjones1999/coup\"],[14,\"target\",\"_blank\"],[14,\"rel\",\"noopener noreferrer\"],[12],[1,\"Source Code\"],[13],[1,\" \\n    | \\n    \"],[10,3],[14,6,\"mailto:shanecjones1999@gmail.com\"],[14,\"target\",\"_blank\"],[14,\"rel\",\"noopener noreferrer\"],[12],[1,\"Careers\"],[13],[1,\" \\n\"],[13]],[],false,[]]",
    "moduleName": "client/components/footer/template.hbs",
    "isStrictMode": false
  });
});
...
;define("client/components/game-rules/component", ["exports", "@glimmer/component", "@ember/service", "@ember/object", "@glimmer/tracking"], function (_exports, _component, _service, _object, _tracking) {
  "use strict";
  ...
  function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
  function _toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
  class GameRules extends _component.default {
    constructor(...args) {
      super(...args);
      _defineProperty(this, "rules", ["The objective in Coup is to be the last player remaining. Each player begins with two cards, referred to as " + "Influences. There are 5 types of Influences:", "LIST INFLUENCES HERE", "Each turn, a player takes one action. If the player is claiming an Influence, their opponents YADADA."]);
      _defineProperty(this, "actions", [{
  ...
  _exports.default = GameRules;
});
;define("client/components/game-rules/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  "use strict";
  ...
  /*
    <div class="game-rules-container">
      <h4>Overview</h4>
      <p>Coup is a game of bluffing and deduction set in a dystopian universe. Players represent powerful members of society who are secretly vying for influence over the government.</p>
  
      <h4>Gameplay</h4>
      <p>The game is played in turns, with each player taking one action per turn. The available actions are:</p>
      <ol>
          <li>Income: Take one coin from the Treasury.</li>
          <li>Foreign Aid: Take two coins from the Treasury. (Can be blocked by a player claiming to have a Duke)</li>
          <li>Tax: Take three coins from the Treasury. (Can be blocked by a player claiming to have a Duke)</li>
          <li>Exchange: Exchange your Influence cards with two cards from the Court deck.</li>
          <li>Assassinate: Pay three coins to launch an assassination attempt against another player's Influence card. (Can be blocked by a player claiming to have a Contessa)</li>
          <li>Steal: Steal two coins from another player. (Can be blocked by a player claiming to have a Captain or Ambassador)</li>
          <li>Coup: Pay seven coins to launch a coup against another player, forcing them to lose one Influence card.</li>
      </ol>
  
      <h4>Winning the Game</h4>
      <p>The last player with Influence cards remaining wins the game.</p>
  
  </div>
  */
  {
    "id": "HgZjffrF",
    "block": "[[[10,0],[14,0,\"game-rules-container\"],[12],[1,\"\\n    \"],[10,\"h4\"],[12],[1,\"Overview\"],[13],[1,\"\\n    \"],[10,2],[12],[1,\"Coup is a game of bluffing and deduction set in a dystopian universe. Players represent powerful members of society who are secretly vying for influence over the government.\"],[13],[1,\"\\n\\n    \"],[10,\"h4\"],[12],[1,\"Gameplay\"],[13],[1,\"\\n    \"],[10,2],[12],[1,\"The game is played in turns, with each player taking one action per turn. The available actions are:\"],[13],[1,\"\\n    \"],[10,\"ol\"],[12],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Income: Take one coin from the Treasury.\"],[13],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Foreign Aid: Take two coins from the Treasury. (Can be blocked by a player claiming to have a Duke)\"],[13],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Tax: Take three coins from the Treasury. (Can be blocked by a player claiming to have a Duke)\"],[13],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Exchange: Exchange your Influence cards with two cards from the Court deck.\"],[13],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Assassinate: Pay three coins to launch an assassination attempt against another player's Influence card. (Can be blocked by a player claiming to have a Contessa)\"],[13],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Steal: Steal two coins from another player. (Can be blocked by a player claiming to have a Captain or Ambassador)\"],[13],[1,\"\\n        \"],[10,\"li\"],[12],[1,\"Coup: Pay seven coins to launch a coup against another player, forcing them to lose one Influence card.\"],[13],[1,\"\\n    \"],[13],[1,\"\\n\\n    \"],[10,\"h4\"],[12],[1,\"Winning the Game\"],[13],[1,\"\\n    \"],[10,2],[12],[1,\"The last player with Influence cards remaining wins the game.\"],[13],[1,\"\\n\\n\"],[13]],[],false,[]]",
    "moduleName": "client/components/game-rules/template.hbs",
    "isStrictMode": false
  });
});
...
;define("client/components/join-create-game/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
  ...
  var _default = _exports.default = (0, _templateFactory.createTemplateFactory)(
  /*
    <div class="join-create-game-container">
      <BsTab as |tab|>
...
;define("client/components/log/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
    ...
    <div class="chat-container">
      <div class="chat-content">
          {{#each @messages as |chat|}}
              {{#if @isChat}}
                  <div class="chat-message {{if (eq @name chat.name) "self" "other"}}"><strong>{{chat.name}}:</strong> {{chat.message}}</div>
              {{else}}
  ...
  */
  {
    "id": "Lz/T/Ia0",
    "block": "[[[10,0],[14,0,\"chat-container\"],[12],[1,\"\\n    \"],[10,0],[14,0,\"chat-content\"],[12],[1,\"\\n\"],[42,[28,[37,1],[[28,[37,1],[[30,1]],null]],null],null,[[[41,[30,3],[[[1,\"                \"],[10,0],[15,0,[29,[\"chat-message \",[52,[28,[37,3],[[30,4],[30,2,[\"name\"]]],null],\"self\",\"other\"]]]],[12],[10,\"strong\"],[12],[1,[30,2,[\"name\"]]],[1,\":\"],[13],[1,\" \"],[1,[30,2,[\"message\"]]],[13],[1,\"\\n\"]],[]],[[[1,\"                \"],[10,0],[14,0,\"chat-message\"],[12],[1,[30,2]],[13],[1,\"\\n\"]],[]]]],[2]],null],[1,\"    \"],[13],[1,\"\\n\"],[13]],[\"@messages\",\"chat\",\"@isChat\",\"@name\"],false,[\"each\",\"-track-array\",\"if\",\"eq\"]]",
...
;define("client/components/nav-bar/component", ["exports", "@glimmer/component", "@ember/service", "@ember/object", "@glimmer/tracking"], function (_exports, _component, _service, _object, _tracking) {
  "use strict";
  ...
  let NavBar = _exports.default = (_class = class NavBar extends _component.default {
    constructor(...args) {
      ...
      _initializerDefineProperty(this, "actionSheetModalOpen", _descriptor3, this);
      _initializerDefineProperty(this, "rulesModalOpen", _descriptor4, this);
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "actionSheetModalOpen", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _applyDecoratedDescriptor(_class.prototype, "openActionSheetModal", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "openActionSheetModal"), _class.prototype), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "rulesModalOpen", [_tracking.tracked], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: function () {
  ...
  }), _applyDecoratedDescriptor(_class.prototype, "openRulesModal", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "openRulesModal"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "invalidateSession", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "invalidateSession"), _class.prototype)), _class);
});
;define("client/components/nav-bar/template", ["exports", "@ember/template-factory"], function (_exports, _templateFactory) {
    ...
    <div class="nav-bar-container">
      <div id="rules-container">
          <div class="nav-bar-button">
              <BsModalSimple
                  @open={{this.rulesModalOpen}}
                  @title="How to play Coup"
                  @closeTitle="Ok"
                  @size=""
                  @closeButton={{true}}
                  @fade={{true}}
          ...
          <div class="nav-bar-button">
              <BsModalSimple
                  @open={{this.actionSheetModalOpen}}
                  @title="Action Sheet"
                  @closeTitle="Ok"
                  @size=""
                  @closeButton={{true}}
              ...
              <BsButton
                  @type="primary"
                  @outline={{true}}
                  @onClick={{this.openActionSheetModal}}
              >Action Sheet
              </BsButton>
          </div>
      </div>
      {{#if (and this.session.isAuthenticated (not (eq this.router.currentRouteName 'game')))}}
  ...
  */
  {
    "id": "4vyqGaKx",
    "block": "[[[10,0],[14,0,\"nav-bar-container\"],[12],[1,\"\\n    \"],[10,0],[14,1,\"rules-container\"],[12],[1,\"\\n        \"],[10,0],[14,0,\"nav-bar-button\"],[12],[1,\"\\n            \"],[8,[39,0],null,[[\"@open\",\"@title\",\"@closeTitle\",\"@size\",\"@closeButton\",\"@fade\",\"@backdrop\",\"@backdropClose\",\"@onSubmit\",\"@onHide\",\"@renderInPlace\"],[[30,0,[\"rulesModalOpen\"]],\"How to play Coup\",\"Ok\",\"\",true,true,true,true,[30,0,[\"submit\"]],[30,0,[\"close\"]],true]],[[\"default\"],[[[[1,\"\\n                \"],[8,[39,1],null,null,null],[1,\"\\n            \"]],[]]]]],[1,\"\\n        \"],[8,[39,2],null,[[\"@type\",\"@outline\",\"@onClick\"],[\"primary\",true,[30,0,[\"openRulesModal\"]]]],[[\"default\"],[[[[1,\"Rules\\n        \"]],[]]]]],[1,\"\\n        \"],[13],[1,\"\\n        \"],[10,0],[14,0,\"nav-bar-button\"],[12],[1,\"\\n            \"],[8,[39,0],null,[[\"@open\",\"@title\",\"@closeTitle\",\"@size\",\"@closeButton\",\"@fade\",\"@backdrop\",\"@backdropClose\",\"@onSubmit\",\"@onHide\",\"@renderInPlace\"],[[30,0,[\"actionSheetModalOpen\"]],\"Action Sheet\",\"Ok\",\"\",true,true,true,true,[30,0,[\"submit\"]],[30,0,[\"close\"]],true]],[[\"default\"],[[[[1,\"\\n                \"],[8,[39,3],null,null,null],[1,\"\\n            \"]],[]]]]],[1,\"\\n            \"],[8,[39,2],null,[[\"@type\",\"@outline\",\"@onClick\"],[\"primary\",true,[30,0,[\"openActionSheetModal\"]]]],[[\"default\"],[[[[1,\"Action Sheet\\n            \"]],[]]]]],[1,\"\\n        \"],[13],[1,\"\\n    \"],[13],[1,\"\\n\"],[41,[28,[37,5],[[30,0,[\"session\",\"isAuthenticated\"]],[28,[37,6],[[28,[37,7],[[30,0,[\"router\",\"currentRouteName\"]],\"game\"],null]],null]],null],[[[1,\"        \"],[10,0],[14,1,\"sign-out-container\"],[12],[1,\"\\n            \"],[10,0],[14,0,\"nav-bar-button\"],[12],[1,\"\\n                \"],[8,[39,2],null,[[\"@type\",\"@outline\",\"@onClick\"],[\"secondary\",true,[30,0,[\"invalidateSession\"]]]],[[\"default\"],[[[[1,\"Sign Out\\n                \"]],[]]]]],[1,\"\\n            \"],[13],[1,\"\\n        \"],[13],[1,\"\\n\"]],[]],null],[13]],[],false,[\"bs-modal-simple\",\"game-rules\",\"bs-button\",\"action-sheet\",\"if\",\"and\",\"not\",\"eq\"]]",
...
;
          if (!runningTests) {
            require("client/app")["default"].create({"name":"client","version":"0.0.0+50445e6d"});
          }

  ...
  /*
    <div class="game-container">
      ...
      <div>
          ...
          {{/if}}
          {{#unless this.model.gameState.started}}
          ...
          <div class="join-game">
              ...
              {{!-- {{#each this.games as |game|}}
                  {{#unless game.isStarted}}
                      <EnterGame @game={{game}} @enterGame={{@enterGame}} />
                  {{/unless}}
              {{/each}} --}}
...
;define("client/controllers/lobby", ["exports", "@ember/controller", "@glimmer/tracking", "@ember/object", "@ember/service", "@ember/runloop", "@ember/object/computed", "client/config/environment"], function (_exports, _controller, _tracking, _object, _service, _runloop, _computed, _environment) {
  ...
  function _applyDecoratedDescriptor(target, property, decorators, descriptor, context) { var desc = {}; Object.keys(descriptor).forEach(function (key) { desc[key] = descriptor[key]; }); desc.enumerable = !!desc.enumerable; desc.configurable = !!desc.configurable; if ('value' in desc || desc.initializer) { desc.writable = true; } desc = decorators.slice().reverse().reduce(function (desc, decorator) { return decorator(target, property, desc) || desc; }, desc); if (context && desc.initializer !== void 0) { desc.value = desc.initializer ? desc.initializer.call(context) : void 0; desc.initializer = undefined; } if (desc.initializer === void 0) { Object.defineProperty(target, property, desc); desc = null; } return desc; }
  function _initializerWarningHelper(descriptor, context) { throw new Error('Decorating class property failed. Please ensure that ' + 'transform-class-properties is enabled and runs after the decorators transform.'); }
  let GamesController = _exports.default = (_dec = (0, _computed.alias)('model.lobby'), _dec2 = (0, _object.computed)('model.games'), (_class = class GamesController extends _controller.default {
    constructor(...args) {
      super(...args);
      _initializerDefineProperty(this, "session", _descriptor, this);
      _initializerDefineProperty(this, "websocket", _descriptor2, this);
      ...
      _initializerDefineProperty(this, "lobby", _descriptor4, this);
    }
    get games() {
    ...
    writable: true,
    initializer: null
  }), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "lobby", [_dec], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
  }), _applyDecoratedDescriptor(_class.prototype, "games", [_dec2], Object.getOwnPropertyDescriptor(_class.prototype, "games"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "fetchModel", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "fetchModel"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "enterGame", [_object.action], Object.getOwnPropertyDescriptor(_class.prototype, "enterGame"), _class.prototype)), _class));
});
...
;
          if (!runningTests) {
            require("client/app")["default"].create({"name":"client","version":"0.0.0+f68d03b1"});
          }
